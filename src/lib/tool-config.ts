...
export const TOOL_CONFIGS: Record<string, ToolConfig> = {
  'js-to-ts': {
    id: 'js-to-ts',
    name: 'JS/JSX to TS/TSX',
    shortName: 'JS/JSX \u2192 TS/TSX',
    path: '/js-to-ts',
    description: 'Convert JavaScript to TypeScript & JSX to TSX',
    category: 'typescript',
    conversionMode: 'ai',
  ...
  'regex-tester': {
    ...
    category: 'utility',
    conversionMode: 'ai',
    icon: { color: 'hsl(160 70% 45%)', label: 'Rx' },
    inputLanguage: 'plaintext',
    outputLanguage: 'plaintext',
    inputFileType: 'REGEX',
    outputFileType: 'TXT',
    inputFileName: 'pattern.regex',
    outputFileName: 'result.txt',
    downloadFileName: 'regex-result.txt',
    emptyStateMessage: 'Enter a regex pattern to start testing',
    emptyStateHint: 'Type a pattern above, paste a test string, and see matches highlighted',
    tags: ['AI-Powered'],
  },
  'package-to-badges': {
    ...
    category: 'markup',
    conversionMode: 'instant',
    icon: { color: 'hsl(160 60% 45%)', label: 'BD' },
    inputLanguage: 'json',
    outputLanguage: 'markdown',
    inputFileType: 'JSON',
    outputFileType: 'MD',
    inputFileName: 'package.json',
    outputFileName: 'badges.md',
  ...
  'markdown-table-converter': {
    ...
    category: 'markup',
    conversionMode: 'instant',
    icon: { color: 'hsl(160 60% 45%)', label: 'MD' },
  ...
  'curl-to-code': {
    ...
    category: 'utility',
    conversionMode: 'ai',
    icon: { color: 'hsl(160 60% 42%)', label: '>' },
    inputLanguage: 'shell',
    outputLanguage: 'javascript',
    inputFileType: 'CURL',
    outputFileType: 'JS',
    inputFileName: 'request.sh',
  ...
  'env-to-types': {
    ...
    category: 'typescript',
    conversionMode: 'instant',
    icon: { color: 'hsl(150 60% 42%)', label: 'EN' },
    inputLanguage: 'ini',
    outputLanguage: 'typescript',
    inputFileType: 'ENV',
    outputFileType: 'TS',
    inputFileName: '.env',
    outputFileName: 'env.ts',
...
export const SIDEBAR_CATEGORIES: SidebarCategoryConfig[] = [
  {
    id: 'typescript',
    label: 'TypeScript',
    toolIds: ['js-to-ts', 'json-to-ts', 'graphql-to-ts', 'proptypes-to-ts', 'sql-to-ts', 'openapi-to-ts', 'env-to-types'],
  },
  {
    id: 'json',
    label: 'JSON',
  ...
  },
  {
    id: 'utility',
    label: 'Utility',
    toolIds: ['regex-tester', 'curl-to-code'],
  },
  {
    id: 'markup',
    label: 'Markup',
    toolIds: ['package-to-badges', 'markdown-table-converter'],
  },
];

...
import { WhySnipShift } from '@/components/landing/why-snipshift';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'SnipShift  Free Online Developer Converter Tools',
    description:
